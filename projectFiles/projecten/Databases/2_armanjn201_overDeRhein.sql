...
CREATE TABLE hijskraan(
    ...
    PRIMARY KEY (Hijskraan_Serienummer)
);


CREATE TABLE Onderwagen(
    ...
    Onderwagen_uitvoering VARCHAR(25) NOT NULL,

    PRIMARY KEY (Onderwagen_identieficatienummer)
);
