...
--
-- Database: `armanjn201_gameplayParties`
--
DROP Database IF EXISTS armanjn201_gameplayParties;
CREATE Database IF NOT EXISTS armanjn201_gameplayParties;
USE armanjn201_gameplayParties;
