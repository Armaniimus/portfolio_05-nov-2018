...
DROP DATABASE IF EXISTS `armanjn201_multiversum`;
CREATE DATABASE IF NOT EXISTS `armanjn201_multiversum` DEFAULT CHARACTER SET utf8;
USE `armanjn201_multiversum`;

-- -----------------------------------------------------
-- Table `Multiversum_DB`.`VR_bril`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `VR_bril` (
...
-- -----------------------------------------------------
INSERT INTO `VR_bril` (`naam`, `model`, `3d_2d`, `resolutie`, `platform`, `merk`, `afbeelding`, `prijs`, `beschrijving`)
