...
--
-- Host: localhost:3306
-- Gegenereerd op: 19 okt 2018 om 00:30
-- Serverversie: 5.7.17
-- PHP-versie: 7.1.16
...
CREATE TABLE `beschikbaarheid_bioscopen` (
  `Beschikbaarheid_bioscopenID` int(10) UNSIGNED NOT NULL,
  `zalen_zaalID` int(10) UNSIGNED NOT NULL,
  `beginDatum` datetime DEFAULT NULL,
  `eindDatum` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Gegevens worden geëxporteerd voor tabel `beschikbaarheid_bioscopen`
--

INSERT INTO `beschikbaarheid_bioscopen` (`Beschikbaarheid_bioscopenID`, `zalen_zaalID`, `beginDatum`, `eindDatum`) VALUES
(1, 1, '2018-10-18 09:30:00', '2018-10-18 11:00:00'),
(2, 1, '2018-10-18 12:30:00', '2018-10-18 14:00:00'),
(3, 2, '2018-10-22 00:00:00', '2018-10-23 00:00:00'),
(4, 10, '2018-10-01 00:00:00', '2018-10-16 00:00:00');
...
CREATE TABLE `betalingen` (
  `betalingenID` int(10) UNSIGNED NOT NULL,
  `BetaaldBedrag` decimal(8,2) DEFAULT NULL,
  `BetaalDatum` datetime DEFAULT NULL,
  `BetalingsMethode` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `betalingen` (`betalingenID`, `BetaaldBedrag`, `BetaalDatum`, `BetalingsMethode`) VALUES
(6, '395.00', '2018-10-18 00:00:00', 'contant-entree'),
(7, '395.00', '2018-10-18 00:00:00', 'contant-entree'),
(8, '395.00', '2018-10-18 00:00:00', 'pinnen-entree'),
(9, '395.00', '2018-10-19 00:00:00', 'pinnen-entree');
...
CREATE TABLE `content` (
  ...
  `content_naam` varchar(80) NOT NULL,
...
CREATE TABLE `facturen` (
  `FactuurNummer` int(10) UNSIGNED NOT NULL,
  `klantnaam` varchar(45) DEFAULT NULL,
  `klantadres` varchar(60) DEFAULT NULL,
...
CREATE TABLE `gebruikers` (
  ...
  `gebruikers_rollen_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `gebruikers_rollen` (`id`, `rolType`, `perm_bios_toevoegen`, `perm_bios_wijzigen`, `perm_bios_verwijderen`, `perm_content_toevoegen`, `perm_content_wijzigen`, `perm_content_verwijderen`, `perm_bios_foto_toevoegen`, `perm_reserverings_overzicht_bios`, `perm_reserverings_overzicht_totaal`) VALUES
(1, 'redacteur', 1, 0, 0, 1, 1, 1, 0, 0, 0),
(2, 'bioscoop', 0, 1, 0, 0, 0, 0, 1, 1, 0);
...
CREATE TABLE `reserveringen` (
  ...
  `Beschikbaarheid_bioscopenID` int(10) UNSIGNED NOT NULL,
  `betalingen_betalingenID` int(10) UNSIGNED NOT NULL,
  `TotaalVerschuldigd` decimal(8,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tarieven` (
  `tariefID` int(10) UNSIGNED NOT NULL,
  `naam` varchar(100) DEFAULT NULL,
  `prijsPerPersoon` decimal(5,2) DEFAULT NULL,
  `bioscopen_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Gegevens worden geëxporteerd voor tabel `tarieven`
--
...
CREATE TABLE `zalen` (
  `zaalID` int(10) UNSIGNED NOT NULL,
  `bioscoop_id` int(11) NOT NULL,
  `zaal` int(11) DEFAULT NULL,
  `aantal stoelen` int(11) DEFAULT NULL,
  `rolstoelplaatsen` int(11) DEFAULT NULL,
  `schermgroote` varchar(45) DEFAULT NULL,
  `facaliteiten` varchar(100) DEFAULT NULL,
  `versies` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indexen voor tabel `beschikbaarheid_bioscopen`
--
ALTER TABLE `beschikbaarheid_bioscopen`
  ADD PRIMARY KEY (`Beschikbaarheid_bioscopenID`);

--
-- Indexen voor tabel `betalingen`
--
ALTER TABLE `betalingen`
  ADD PRIMARY KEY (`betalingenID`);
...
ALTER TABLE `content`
  ...
  ADD UNIQUE KEY `content_naam` (`content_naam`);
...
ALTER TABLE `gebruikers_rollen`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `rolType` (`rolType`);
...
--
-- AUTO_INCREMENT voor een tabel `beschikbaarheid_bioscopen`
--
ALTER TABLE `beschikbaarheid_bioscopen`
  MODIFY `Beschikbaarheid_bioscopenID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT voor een tabel `betalingen`
--
ALTER TABLE `betalingen`
  MODIFY `betalingenID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT voor een tabel `bioscopen`
--
ALTER TABLE `bioscopen`
  MODIFY `bioscoopID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `facturen`
  MODIFY `FactuurNummer` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
...
--
ALTER TABLE `reserveringen`
  MODIFY `reserveringenID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT voor een tabel `tarieven`
--
ALTER TABLE `tarieven`
  MODIFY `tariefID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT voor een tabel `toeslagen`
--
ALTER TABLE `toeslagen`
  MODIFY `toeslagenID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT voor een tabel `zalen`
--
ALTER TABLE `zalen`
  MODIFY `zaalID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
COMMIT;
